...
**共性流程及功能**（其中斜体部分在线下进行）  
     1. 学生网上填写活动基本信息，使用学生清华网站中的**大型学生活动申请向导**生成申请表，并可直接打印为纸质表格；  
       填写相关信息：  
...
* **文号查询申请**
	...
	1. 各部门登陆后可查询历史文号、现有文号排序，可查看并下载发文内容。
...
<!-- 这部分需要联系办公室和组织部协作完成 -->
	...
	4. 留任辅导员权限管理
		1.留任辅导员的的权限，原则上应该收回，或改成只读形式。
	5. 辅导员工作周报
		1. 辅导员每周上网填写工作周报，作为档案的一部分，且工作周报对团委全部其他辅导员、教师可见。
