...
* **定期简报**  
包括校团委全体会工作简报、每月团内信息、大型活动周报及其他需要收集统计的信息等（不限定，可根据需要增加删除，各部门都可以发布收集简报，由权限决定不同的发布范围）
...
**流程及功能**  
     1. 财务负责人录入账目信息（记账摘要、所属费用类型、部门/项目、预支金额、实支金额、应补/应退、项目编号、经费来源等），其中所属费用类型、部门/项目等是可选项（标签），可以选择已有的选项，也可创建新选项。
     2. 录入的账目信息自动汇总为账务明细表格，可以根据各项进行排序、筛选、进一步的编辑。可以根据部门、项目等筛选列出具体账目，并且进行简单统计。
     3. 财务负责人可以设定项目/部门对应的校团委的负责人，校团委书记/副书记/部长可以查询分管部门的账目信息。  
* **预决算管理**  
...
* **借还款办理**  
即实现同学填写借款申请，部门负责人和团委财务员确认的在线登记过程，录入信息同时纳入上述的团委账目中。
**流程及功能**  
     1. 同学填写申请借款凭证，内容包括用途摘要、借款方式、金额、所属部门、经费来源、收款单位信息、借款人联系方式等
     2. 填写确认后，推送至部门负责人对该笔借款进行确认。部门负责人确认无误后，由团委财务员进行确认，确认通过后借款即进入线下流程。线下借款流程办理后（转账完成或交付现金后），账目即进入团委财务明细账。
     3. 团委财务员可以查看所有借款情况。借款人、部门负责人、主管副书记可以根据权限查询所负责的借款情况，借款情况汇总为借款登记簿表格。
